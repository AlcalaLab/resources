Below is a compendium of best practices for keeping a digital lab notebook. This is intended for those in our lab group, however [comments and suggestions are welcome](https://github.com/AlcalaLab/resources/issues).
...
|Shama Hasan | [shamahasan.github.io](https://shamahasan.github.io/sh_notebook/notebook.html) | ![GitHub last commit](https://img.shields.io/github/last-commit/sh_notebook) |
...
## Document daily
A record of your work should be published ***each day*** of activity! Even if you feel like you did nothing, post <em>something</em> to describe what you did that day. 
